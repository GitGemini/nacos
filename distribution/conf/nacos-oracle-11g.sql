...
/*
 *  Oracle 12c及以上才支持主键自增，11g及一下不支持
 *  这里使用序列与触发器模拟自增主键
 */

CREATE SEQUENCE CONFIG_INFO_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_CONFIG_INFO_id
BEFORE INSERT
ON CONFIG_INFO
...
BEGIN
  ...
  SELECT CONFIG_INFO_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_CONFIG_INFO_id ENABLE;

CREATE SEQUENCE CONFIG_INFO_AGGR_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_CONFIG_INFO_AGGR_id
BEFORE INSERT
ON CONFIG_INFO_AGGR
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT CONFIG_INFO_AGGR_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_CONFIG_INFO_AGGR_id ENABLE;

CREATE SEQUENCE CONFIG_INFO_BETA_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_CONFIG_INFO_BETA_id
BEFORE INSERT
ON CONFIG_INFO_BETA
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT CONFIG_INFO_BETA_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_CONFIG_INFO_BETA_id ENABLE;

CREATE SEQUENCE CONFIG_INFO_TAG_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_CONFIG_INFO_TAG_id
BEFORE INSERT
ON CONFIG_INFO_TAG
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT CONFIG_INFO_TAG_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_CONFIG_INFO_TAG_id ENABLE;

CREATE SEQUENCE CONFIG_TAGS_RELATION_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_CONFIG_TAGS_RELATION_nid
BEFORE INSERT
...
BEGIN
  ...
  SELECT CONFIG_TAGS_RELATION_seq.nextval
  INTO :new.nid
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_CONFIG_TAGS_RELATION_nid ENABLE;

CREATE SEQUENCE GROUP_CAPACITY_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_GROUP_CAPACITY_id
BEFORE INSERT
ON GROUP_CAPACITY
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT GROUP_CAPACITY_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_GROUP_CAPACITY_id ENABLE;

CREATE SEQUENCE HIS_CONFIG_INFO_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_HIS_CONFIG_INFO_nid
BEFORE INSERT
ON HIS_CONFIG_INFO
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.nid is null) then
  SELECT HIS_CONFIG_INFO_seq.nextval
  INTO :new.nid
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_HIS_CONFIG_INFO_nid ENABLE;

CREATE SEQUENCE TENANT_CAPACITY_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_TENANT_CAPACITY_id
BEFORE INSERT
ON TENANT_CAPACITY
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT TENANT_CAPACITY_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_TENANT_CAPACITY_id ENABLE;

CREATE SEQUENCE TENANT_INFO_seq
	START WITH 1 MINVALUE 1 INCREMENT BY 1 NOCACHE;

CREATE OR REPLACE TRIGGER tr_TENANT_INFO_id
BEFORE INSERT
ON TENANT_INFO
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
BEGIN
  if(:new.id is null) then
  SELECT TENANT_INFO_seq.nextval
  INTO :new.id
  FROM dual;
  end if;
END;

ALTER TRIGGER tr_TENANT_INFO_id ENABLE;
